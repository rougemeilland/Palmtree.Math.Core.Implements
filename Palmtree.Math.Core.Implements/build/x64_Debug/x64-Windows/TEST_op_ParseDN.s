...
.LVL5:
	...
	.loc 2 56 84
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84003(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84002(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 56 9
	...
	call	TEST_Assert
	.loc 2 57 74
	movq	actual_buf_size.84003(%rip), %rax
	movq	120(%rbp), %rcx
	movq	112(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84002(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 57 9
	testl	%eax, %eax
	sete	%al
...
.LVL13:
	...
	.loc 2 80 84
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84019(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84018(%rip), %rdx
	call	*%rax
.LVL14:
	movl	%eax, -8(%rbp)
	.loc 2 80 9
	...
	call	TEST_Assert
	.loc 2 81 74
	movq	actual_buf_size.84019(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84018(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 81 9
	testl	%eax, %eax
	sete	%al
...
.LFE4275:
	.seh_endproc
.lcomm actual_buf.84002,256,32
.lcomm actual_buf_size.84003,8,8
.lcomm actual_buf.84018,256,32
.lcomm actual_buf_size.84019,8,8
.Letext0:
	...
	.file 30 "pmc.h"
	.file 31 "C:/GNU/MINGW64/x86_64-8.1.0-win32-seh-rt_v6-rev0/mingw64/x86_64-w64-mingw32/include/winbase.h"
