...
.LVL5:
	...
	.loc 2 56 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84374(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84373(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 56 9
	...
	call	TEST_Assert
	.loc 2 57 75
	movq	actual_buf_size.84374(%rip), %rax
	movq	120(%rbp), %rcx
	movq	112(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84373(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 57 9
	testl	%eax, %eax
	sete	%al
...
.LVL13:
	...
	.loc 2 80 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84390(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84389(%rip), %rdx
	call	*%rax
.LVL14:
	movl	%eax, -8(%rbp)
	.loc 2 80 9
	...
	call	TEST_Assert
	.loc 2 81 75
	movq	actual_buf_size.84390(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84389(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 81 9
	testl	%eax, %eax
	sete	%al
...
.LFE4275:
	.seh_endproc
.lcomm actual_buf.84373,256,32
.lcomm actual_buf_size.84374,8,8
.lcomm actual_buf.84389,256,32
.lcomm actual_buf_size.84390,8,8
.Letext0:
