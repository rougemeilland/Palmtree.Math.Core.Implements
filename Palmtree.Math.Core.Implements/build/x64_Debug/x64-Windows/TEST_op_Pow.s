...
.LC1:
	.ascii "PMC_Pow_X_I (%d.%d)\0"
	.align 8
.LC2:
	.ascii "PMC_Pow_X_I\343\201\256\345\276\251\345\270\260\343\202\263\343\203\274\343\203\211\343\201\214\346\234\237\345\276\205\351\200\232\343\202\212\343\201\247\343\201\257\343\201\252\343\201\204(%d)\0"
	.align 8
.LC3:
...
.LC4:
	...
	.text
	.globl	TEST_PMC_Pow_X_I
	.def	TEST_PMC_Pow_X_I;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_Pow_X_I
TEST_PMC_Pow_X_I:
.LFB4274:
	.file 2 "TEST_op_Pow.c"
	.loc 2 40 1
	.cfi_startproc
	pushq	%rbp
	.seh_pushreg	%rbp
...
.LVL1:
	...
	movq	%rdx, %r9
	movl	$65536, %r8d
	leaq	actual_z_buf.84371(%rip), %rdx
	call	*%rax
.LVL2:
	movl	%eax, -12(%rbp)
	.loc 2 52 9
	...
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_z_buf.84371(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 53 9
	testl	%eax, %eax
	sete	%al
...
.LFE4274:
	.seh_endproc
.lcomm actual_z_buf.84371,65536,32
.Letext0:
