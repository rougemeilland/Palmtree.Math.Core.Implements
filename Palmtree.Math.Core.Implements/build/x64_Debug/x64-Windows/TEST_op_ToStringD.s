...
.LC5:
	...
	.align 8
.LC6:
	.ascii "T\0o\0S\0t\0r\0i\0n\0g\0D\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.align 8
.LC7:
...
.LVL5:
	...
	movl	%edx, %r9d
	movl	$8192, %r8d
	leaq	actual_str_buffer.84369(%rip), %rdx
	call	*%r10
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 1 53 5
	...
	movq	88(%rbp), %rax
	movq	%rax, %rdx
	leaq	actual_str_buffer.84369(%rip), %rcx
...
.LFE4274:
	.seh_endproc
.lcomm actual_str_buffer.84369,8192,32
.Letext0:
