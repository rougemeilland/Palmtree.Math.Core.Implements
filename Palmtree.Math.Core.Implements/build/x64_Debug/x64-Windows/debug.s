...
.LFB4379:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.85740(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL7:
	.loc 1 131 12
	leaq	buffer.85740(%rip), %rax
	.loc 1 132 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFB4380:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.85745(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL8:
	.loc 1 138 12
	leaq	buffer.85745(%rip), %rax
	.loc 1 139 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFE4381:
	.seh_endproc
.lcomm buffer.85740,256,32
.lcomm buffer.85745,256,32
.Letext0:
