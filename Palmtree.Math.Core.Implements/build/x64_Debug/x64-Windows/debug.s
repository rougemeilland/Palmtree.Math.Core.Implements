...
.LFB4376:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.85643(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL7:
	.loc 1 128 12
	leaq	buffer.85643(%rip), %rax
	.loc 1 129 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFB4377:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.85648(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL8:
	.loc 1 135 12
	leaq	buffer.85648(%rip), %rax
	.loc 1 136 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFE4377:
	.seh_endproc
.lcomm buffer.85643,256,32
.lcomm buffer.85648,256,32
.Letext0:
