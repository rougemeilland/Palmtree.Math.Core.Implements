...
.LFB4373:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.85266(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL7:
	.loc 1 128 12
	leaq	buffer.85266(%rip), %rax
	.loc 1 129 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFB4374:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.85271(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL8:
	.loc 1 135 12
	leaq	buffer.85271(%rip), %rax
	.loc 1 136 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFE4374:
	.seh_endproc
.lcomm buffer.85266,256,32
.lcomm buffer.85271,256,32
.Letext0:
