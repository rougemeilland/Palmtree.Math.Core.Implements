...
.LFB4373:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.84978(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL7:
	.loc 1 125 12
	leaq	buffer.84978(%rip), %rax
	.loc 1 126 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFB4374:
	...
	movl	%eax, %r8d
	movq	16(%rbp), %rdx
	leaq	buffer.84983(%rip), %rcx
	movq	__imp_wsprintfA(%rip), %rax
	call	*%rax
.LVL8:
	.loc 1 132 12
	leaq	buffer.84983(%rip), %rax
	.loc 1 133 1
	addq	$32, %rsp
	popq	%rbp
	.cfi_restore 6
...
.LFE4374:
	.seh_endproc
.lcomm buffer.84978,256,32
.lcomm buffer.84983,256,32
.Letext0:
