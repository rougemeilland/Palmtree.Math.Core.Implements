...
.LFE4310:
	.seh_endproc
	.def	_ZERO_MEMORY_64;	.scl	3;	.type	32;	.endef
	.seh_proc	_ZERO_MEMORY_64
_ZERO_MEMORY_64:
.LFB4314:
	.loc 1 255 1
	.cfi_startproc
...
.LFB4354:
	...
	cmpq	$0, 16(%rbp)
	je	.L55
	.loc 4 314 21 discriminator 1
	movq	16(%rbp), %rax
	movzbl	32(%rax), %eax
	andl	$1, %eax
	.loc 4 314 18 discriminator 1
	testb	%al, %al
	je	.L55
	.loc 4 316 5
	movq	16(%rbp), %rcx
...
.Ldebug_info0:
	...
	.byte	0
	.uleb128 0x32
	.ascii "_ZERO_MEMORY_64\0"
	.byte	0x1
	.byte	0xfe
	.byte	0x16
	.quad	.LFB4314
	.quad	.LFE4314-.LFB4314
	.uleb128 0x1
	.byte	0x9c
	.long	0x593a
	.uleb128 0x2c
