...
.LFB4415:
	...
	testb	%al, %al
	je	.L127
	.loc 4 584 80 is_stmt 0 discriminator 1
	leaq	Add_X_X_using_ADCX(%rip), %rax
	jmp	.L128
.L127:
	.loc 4 584 80 discriminator 2
	leaq	Add_X_X_using_ADC(%rip), %rax
.L128:
	.loc 4 584 26 is_stmt 1 discriminator 4
	movq	%rax, fp_Add_X_X_using_ADC(%rip)
	.loc 4 585 12 discriminator 4
	movl	$0, %eax
	.loc 4 586 1 discriminator 4
	popq	%rbp
	.cfi_restore 6
	.cfi_def_cfa 7, 8
	ret
