...
.LC3:
	...
	.text
	.p2align 4,,15
	.globl	TEST_PMC_Compare_X_I
	.def	TEST_PMC_Compare_X_I;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_Compare_X_I
TEST_PMC_Compare_X_I:
	pushq	%r13
	.seh_pushreg	%r13
	pushq	%r12
	.seh_pushreg	%r12
...
.LC5:
	...
	.text
	.p2align 4,,15
	.globl	TEST_PMC_Compare_X_L
	.def	TEST_PMC_Compare_X_L;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_Compare_X_L
TEST_PMC_Compare_X_L:
	pushq	%r13
	.seh_pushreg	%r13
	pushq	%r12
	.seh_pushreg	%r12
...
.LC7:
	...
	.text
	.p2align 4,,15
	.globl	TEST_PMC_Compare_X_X
	.def	TEST_PMC_Compare_X_X;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_Compare_X_X
TEST_PMC_Compare_X_X:
	pushq	%r14
	.seh_pushreg	%r14
	pushq	%r13
	.seh_pushreg	%r13
