...
.LC5:
	...
	.text
	.p2align 4,,15
	.globl	TEST_PMC_ToStringN
	.def	TEST_PMC_ToStringN;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_ToStringN
TEST_PMC_ToStringN:
	pushq	%r15
	.seh_pushreg	%r15
	pushq	%r14
	...
	movq	%rbx, 40(%rsp)
	movl	$8192, %r8d
	leaq	actual_str_buffer.91236(%rip), %rdx
	movq	%rax, %r13
	movq	56(%rsp), %rcx
	movl	240(%rsp), %eax
	movl	%eax, 32(%rsp)
	...
	call	TEST_Assert
	movq	280(%rsp), %rdx
	leaq	actual_str_buffer.91236(%rip), %rcx
...
.L1:
	...
	ret
	.seh_endproc
.lcomm actual_str_buffer.91236,8192,32
