...
FormatTestLabel:
	...
	movl	%edx, %r8d
	movq	%rcx, %rdx
	leaq	buffer.92416(%rip), %rcx
	call	*__imp_wsprintfA(%rip)
	leaq	buffer.92416(%rip), %rax
	addq	$40, %rsp
	ret
	.seh_endproc
	.p2align 4,,15
...
FormatTestMesssage:
	...
	movl	%edx, %r8d
	movq	%rcx, %rdx
	leaq	buffer.92421(%rip), %rcx
	call	*__imp_wsprintfA(%rip)
	leaq	buffer.92421(%rip), %rax
	addq	$40, %rsp
	ret
	.seh_endproc
.lcomm buffer.92421,256,32
.lcomm buffer.92416,256,32
	.globl	test_ok_count
	.bss
	.align 4
test_ok_count:
