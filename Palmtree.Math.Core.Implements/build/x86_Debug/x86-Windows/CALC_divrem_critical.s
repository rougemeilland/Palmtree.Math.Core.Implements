...
L31:
	...
	testb	%al, %al
	jne	L32
	.loc 3 148 17 discriminator 1
	movl	-128(%ebp), %ebx
	.loc 3 148 36 discriminator 1
	movl	-148(%ebp), %edi
	movl	-132(%ebp), %esi
	.loc 3 148 55 discriminator 1
	movl	-136(%ebp), %eax
	leal	-136(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	-64(%ebp), %edx
