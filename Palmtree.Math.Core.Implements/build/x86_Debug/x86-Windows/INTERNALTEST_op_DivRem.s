...
LFB4243:
	...
	cmpl	32(%ebp), %eax
	jbe	L9
	.loc 4 68 76 discriminator 1
	movl	24(%ebp), %eax
	subl	32(%ebp), %eax
	.loc 4 68 95 discriminator 1
	addl	$5, %eax
	.loc 4 68 33 discriminator 1
	sall	$3, %eax
	jmp	L10
L9:
	.loc 4 68 33 is_stmt 0 discriminator 2
	movl	$32, %eax
L10:
	.loc 4 68 33 discriminator 4
	leal	-100(%ebp), %edx
	movl	%edx, 8(%esp)
	leal	-96(%ebp), %edx
	movl	%edx, 4(%esp)
	...
	call	_AllocateBlock
	movl	%eax, -40(%ebp)
	.loc 4 72 33 is_stmt 1 discriminator 4
	movl	24(%ebp), %eax
	addl	$4, %eax
	leal	0(,%eax,8), %edx
	leal	-108(%ebp), %eax
	...
	movl	%eax, (%esp)
	call	_DivRem_X_X
	.loc 4 76 48 discriminator 4
	movl	-96(%ebp), %eax
	.loc 4 76 12 discriminator 4
	sall	$2, %eax
	movl	%eax, -12(%ebp)
	.loc 4 77 20 discriminator 4
	movl	-40(%ebp), %eax
	movl	%eax, -48(%ebp)
	.loc 4 78 11 discriminator 4
	jmp	L11
L13:
	.loc 4 79 9
	subl	$1, -12(%ebp)
...
L15:
	...
	cmpl	$0, -16(%ebp)
	je	L16
	.loc 4 85 42 discriminator 1
	movl	-16(%ebp), %eax
	leal	-1(%eax), %edx
	movl	-52(%ebp), %eax
	addl	%edx, %eax
	movzbl	(%eax), %eax
	.loc 4 85 31 discriminator 1
	testb	%al, %al
	je	L17
L16:
	.loc 4 87 8
