...
LFE4242:
	.section .rdata,"dr"
LC0:
	.ascii "DivRem_X_X (%d.%d)\0"
	.align 4
LC1:
	.ascii "work_v_buf\343\201\256\345\206\205\345\256\271\343\201\214\347\240\264\346\220\215\343\201\227\343\201\246\343\201\204\343\202\213\0"
	.align 4
LC2:
	.ascii "actual_q_buf\343\201\256\345\206\205\345\256\271\343\201\214\347\240\264\346\220\215\343\201\227\343\201\246\343\201\204\343\202\213\0"
	.align 4
LC3:
	.ascii "actual_r_buf\343\201\256\345\206\205\345\256\271\343\201\214\347\240\264\346\220\215\343\201\227\343\201\246\343\201\204\343\202\213\0"
	.align 4
LC4:
	.ascii "\345\225\206\343\201\256\343\203\207\343\203\274\343\202\277\343\201\256\345\206\205\345\256\271\343\201\214\344\270\200\350\207\264\343\201\227\343\201\252\343\201\204\0"
	.align 4
LC5:
	.ascii "\345\211\260\344\275\231\343\201\256\343\203\207\343\203\274\343\202\277\343\201\256\345\206\205\345\256\271\343\201\214\344\270\200\350\207\264\343\201\227\343\201\252\343\201\204\0"
	.text
...
LFB4243:
	...
	cmpl	32(%ebp), %eax
	jbe	L9
	.loc 4 67 76 discriminator 1
	movl	24(%ebp), %eax
	subl	32(%ebp), %eax
	.loc 4 67 95 discriminator 1
	addl	$5, %eax
	.loc 4 67 33 discriminator 1
	sall	$3, %eax
	jmp	L10
L9:
	.loc 4 67 33 is_stmt 0 discriminator 2
	movl	$32, %eax
L10:
	.loc 4 67 33 discriminator 4
	leal	-100(%ebp), %edx
	movl	%edx, 8(%esp)
	leal	-96(%ebp), %edx
	movl	%edx, 4(%esp)
	...
	call	_AllocateBlock
	movl	%eax, -40(%ebp)
	.loc 4 71 33 is_stmt 1 discriminator 4
	movl	24(%ebp), %eax
	addl	$4, %eax
	leal	0(,%eax,8), %edx
	leal	-108(%ebp), %eax
	...
	movl	%eax, (%esp)
	call	_DivRem_X_X
	.loc 4 75 48 discriminator 4
	movl	-96(%ebp), %eax
	.loc 4 75 12 discriminator 4
	sall	$2, %eax
	movl	%eax, -12(%ebp)
	.loc 4 76 20 discriminator 4
	movl	-40(%ebp), %eax
	movl	%eax, -48(%ebp)
	.loc 4 77 11 discriminator 4
	jmp	L11
L13:
	.loc 4 78 9
	subl	$1, -12(%ebp)
L11:
	...
	cmpl	$0, -12(%ebp)
	je	L12
	.loc 4 77 42 discriminator 1
	movl	-12(%ebp), %eax
	leal	-1(%eax), %edx
	movl	-48(%ebp), %eax
	addl	%edx, %eax
	movzbl	(%eax), %eax
	.loc 4 77 31 discriminator 1
	testb	%al, %al
	je	L13
L12:
	.loc 4 79 8
...
L15:
	...
	cmpl	$0, -16(%ebp)
	je	L16
	.loc 4 84 42 discriminator 1
	movl	-16(%ebp), %eax
	leal	-1(%eax), %edx
	movl	-52(%ebp), %eax
	addl	%edx, %eax
	movzbl	(%eax), %eax
	.loc 4 84 31 discriminator 1
	testb	%al, %al
	je	L17
L16:
	.loc 4 86 8
