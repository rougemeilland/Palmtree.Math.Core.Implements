...
LFE4242:
	.section .rdata,"dr"
LC0:
	.ascii "Multiply_X_X_Imp (%d.%d)\0"
	.align 4
LC1:
	.ascii "actual_w_buf\343\201\256\345\206\205\345\256\271\343\201\214\347\240\264\346\220\215\343\201\227\343\201\246\343\201\204\343\202\213\0"
	.align 4
LC2:
...
L11:
	...
	cmpl	$0, -12(%ebp)
	je	L12
	.loc 4 64 42 discriminator 1
	movl	-12(%ebp), %eax
	leal	-1(%eax), %edx
	movl	-32(%ebp), %eax
	addl	%edx, %eax
	movzbl	(%eax), %eax
	.loc 4 64 31 discriminator 1
	testb	%al, %al
	je	L13
L12:
	.loc 4 66 8
