...
LVL5:
	...
	.loc 2 56 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61356, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61355, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 57 75
	movl	_actual_buf_size.61356, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61355, (%esp)
...
LVL13:
	...
	.loc 2 80 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61372, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61371, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 81 75
	movl	_actual_buf_size.61372, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61371, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 81 9
	testl	%eax, %eax
	sete	%al
...
L14:
	...
	.cfi_endproc
LFE73:
.lcomm _actual_buf.61355,256,32
.lcomm _actual_buf_size.61356,4,4
.lcomm _actual_buf.61371,256,32
.lcomm _actual_buf_size.61372,4,4
Letext0:
