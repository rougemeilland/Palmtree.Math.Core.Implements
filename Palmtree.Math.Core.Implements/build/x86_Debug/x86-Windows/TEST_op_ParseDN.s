...
LVL5:
	...
	.loc 2 56 84
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61333, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61332, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 57 74
	movl	_actual_buf_size.61333, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61332, (%esp)
...
LVL13:
	...
	.loc 2 80 84
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61349, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61348, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 81 74
	movl	_actual_buf_size.61349, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61348, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 81 9
	testl	%eax, %eax
	sete	%al
...
L14:
	...
	.cfi_endproc
LFE73:
.lcomm _actual_buf.61332,256,32
.lcomm _actual_buf_size.61333,4,4
.lcomm _actual_buf.61348,256,32
.lcomm _actual_buf_size.61349,4,4
Letext0:
