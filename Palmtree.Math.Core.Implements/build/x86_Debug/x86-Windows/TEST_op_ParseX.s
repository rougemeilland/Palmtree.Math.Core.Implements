...
LVL5:
	...
	.loc 2 55 82
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.60972, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.60971, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 56 72
	movl	_actual_buf_size.60972, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.60971, (%esp)
...
L10:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_buf.60971,256,32
.lcomm _actual_buf_size.60972,4,4
Letext0:
