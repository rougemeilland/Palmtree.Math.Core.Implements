...
LC4:
	...
	.text
	.globl	_TEST_PMC_Pow_X_I
	.def	_TEST_PMC_Pow_X_I;	.scl	2;	.type	32;	.endef
_TEST_PMC_Pow_X_I:
LFB72:
...
LVL1:
	...
	movl	%ecx, 12(%esp)
	movl	$65536, 8(%esp)
	movl	$_actual_z_buf.61290, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL2:
	subl	$16, %esp
...
L11:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_z_buf.61290,65536,32
Letext0:
