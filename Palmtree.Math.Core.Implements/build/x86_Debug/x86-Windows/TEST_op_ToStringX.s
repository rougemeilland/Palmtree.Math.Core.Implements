...
LC5:
	...
	.align 4
LC6:
	.ascii "T\0o\0S\0t\0r\0i\0n\0g\0X\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.align 4
LC7:
...
LVL5:
	...
	movl	%ecx, 12(%esp)
	movl	$8192, 8(%esp)
	movl	$_actual_str_buffer.61342, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$24, %esp
	...
	movl	36(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_actual_str_buffer.61342, (%esp)
...
L3:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_str_buffer.61342,8192,32
Letext0:
