...
LC4:
	.ascii "GNUC\0"
LC5:
	.ascii "PLATFORM: %s\12\0"
LC6:
	.ascii "COMPILER: %s\12\0"
	.align 4
LC7:
	.ascii "CPU-INFO: POPCNT=%d, ADX=%d, BMI1=%d, BMI2=%d, ABM=%d\12\0"
	.text
	.globl	_DoDebug@4
...
LFB4243:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.84081, (%esp)
	movl	__imp__wsprintfA, %eax
	call	*%eax
LVL7:
	.loc 1 125 12
	movl	$_buffer.84081, %eax
	.loc 1 126 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LFB4244:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.84086, (%esp)
	movl	__imp__wsprintfA, %eax
	call	*%eax
LVL8:
	.loc 1 132 12
	movl	$_buffer.84086, %eax
	.loc 1 133 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
	...
	.cfi_endproc
LFE4244:
.lcomm _buffer.84081,256,32
.lcomm _buffer.84086,256,32
Letext0:
	...
	.file 32 "pmc_debug.h"
	.file 33 "C:/GNU/MINGW64/i686-8.1.0-win32-dwarf-rt_v6-rev0/mingw32/i686-w64-mingw32/include/winuser.h"
