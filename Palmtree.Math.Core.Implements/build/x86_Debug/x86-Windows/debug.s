...
LFE74:
	...
	.align 4
LC2:
	.ascii "P\0M\0C\0_\0I\0n\0i\0t\0i\0a\0l\0i\0z\0e\0 \0f\0a\0i\0l\0e\0d\0\0\0"
	.align 2
LC3:
	.ascii "x\0"
	.ascii "8\0"
...
LFB77:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.61375, (%esp)
	movl	__imp__wsprintfW, %eax
	call	*%eax
LVL7:
	.loc 1 131 12
	movl	$_buffer.61375, %eax
	.loc 1 132 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LFB78:
	...
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_buffer.61380, (%esp)
	movl	__imp__wsprintfW, %eax
	call	*%eax
LVL8:
	.loc 1 138 12
	movl	$_buffer.61380, %eax
	.loc 1 139 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LBE2:
	...
	.cfi_endproc
LFE79:
.lcomm _buffer.61375,512,32
.lcomm _buffer.61380,512,32
Letext0:
