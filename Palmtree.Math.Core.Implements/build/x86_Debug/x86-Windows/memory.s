...
L23:
	...
	jmp	L26
L25:
	.loc 4 162 111 discriminator 2
	movl	$0, %ecx
L26:
	.loc 4 162 8 discriminator 4
	movl	-12(%ebp), %eax
	addl	$1, %eax
	leal	0(,%eax,4), %edx
	movl	-24(%ebp), %eax
	addl	%edx, %eax
	.loc 4 162 21 discriminator 4
	movl	%ecx, (%eax)
	.loc 4 163 10 discriminator 4
	movl	-24(%ebp), %eax
	addl	$4, %eax
L24:
	.loc 4 164 1
...
LFB4224:
	...
	cmpl	$0, 8(%ebp)
	je	L56
	.loc 4 306 21 discriminator 1
	movl	8(%ebp), %eax
	movzbl	12(%eax), %eax
	andl	$1, %eax
	.loc 4 306 18 discriminator 1
	testb	%al, %al
	je	L56
	.loc 4 308 5
	movl	8(%ebp), %eax
...
L65:
	...
	.cfi_endproc
LFE4226:
	.def	_IsPowerOfTwo;	.scl	3;	.type	32;	.endef
_IsPowerOfTwo:
LFB4227:
	.loc 4 333 1
	.cfi_startproc
