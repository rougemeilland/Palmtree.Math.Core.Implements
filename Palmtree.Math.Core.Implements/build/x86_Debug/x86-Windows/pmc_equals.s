...
L41:
	...
	cmpl	%eax, %edx
	jne	L42
	.loc 2 189 50 discriminator 1
	movl	8(%ebp), %eax
	movl	32(%eax), %eax
	.loc 2 189 57 discriminator 1
	movl	(%eax), %eax
	.loc 2 189 46 discriminator 1
	cmpl	%eax, -16(%ebp)
	jne	L42
	.loc 2 189 46 is_stmt 0 discriminator 3
	movl	$1, %edx
	jmp	L43
L42:
	.loc 2 189 46 discriminator 4
	movl	$0, %edx
L43:
	.loc 2 189 24 is_stmt 1 discriminator 6
	movl	20(%ebp), %eax
	movl	%edx, (%eax)
L35:
LBE5:
