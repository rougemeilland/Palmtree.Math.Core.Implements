...
L36:
	...
	cmpl	%eax, %edx
	jne	L37
	.loc 2 177 52 discriminator 1
	movl	-12(%ebp), %eax
	movl	24(%eax), %eax
	.loc 2 177 59 discriminator 1
	movl	(%eax), %eax
	.loc 2 177 47 discriminator 1
	cmpl	%eax, -24(%ebp)
	jne	L37
	.loc 2 177 47 is_stmt 0 discriminator 3
	movl	$1, %edx
	jmp	L38
L37:
	.loc 2 177 47 discriminator 4
	movl	$0, %edx
L38:
	.loc 2 177 24 is_stmt 1 discriminator 6
	movl	20(%ebp), %eax
	movl	%edx, (%eax)
L30:
LBE5:
