...
L80:
	...
	cmpl	$0, -20(%ebp)
	jne	L81
	.loc 3 352 60 discriminator 1
	movl	-80(%ebp), %eax
	movl	%eax, (%esp)
	call	__TZCNT_ALT_UNIT
	.loc 3 352 58 discriminator 1
	addl	$32, %eax
	jmp	L82
L81:
	.loc 3 352 84 discriminator 2
	movl	-20(%ebp), %eax
	movl	%eax, (%esp)
	call	__TZCNT_ALT_UNIT
L82:
	.loc 3 352 33 discriminator 4
	movl	%eax, -72(%ebp)
	.loc 3 353 37 discriminator 4
	movl	-72(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	-68(%ebp), %eax
	movl	%eax, (%esp)
