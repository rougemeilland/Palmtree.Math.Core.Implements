...
L107:
	...
	cmpl	$-258, -16(%ebp)
	je	L109
	.loc 4 598 57 is_stmt 0 discriminator 1
	movl	-16(%ebp), %eax
	jmp	L123
L109:
	.loc 4 598 57 discriminator 2
	movl	$-2, %eax
	jmp	L123
L108:
	.loc 4 600 35 is_stmt 1
	movl	-52(%ebp), %edx
	.loc 4 600 53
	movl	-44(%ebp), %eax
	.loc 4 600 35
...
L116:
	...
	cmpl	$-258, -16(%ebp)
	je	L118
	.loc 4 619 57 is_stmt 0 discriminator 1
	movl	-16(%ebp), %eax
	jmp	L123
L118:
	.loc 4 619 57 discriminator 2
	movl	$-2, %eax
	jmp	L123
L117:
