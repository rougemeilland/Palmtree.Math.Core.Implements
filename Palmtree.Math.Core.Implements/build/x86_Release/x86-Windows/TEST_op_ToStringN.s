...
LC5:
	...
	.text
	.p2align 4,,15
	.globl	_TEST_PMC_ToStringN
	.def	_TEST_PMC_ToStringN;	.scl	2;	.type	32;	.endef
_TEST_PMC_ToStringN:
LFB84:
	.cfi_startproc
	pushl	%ebp
	...
	movl	%eax, (%esp)
	movl	132(%esp), %eax
	movl	$_actual_str_buffer.61028, 4(%esp)
	call	*160(%eax)
	...
	call	_TEST_Assert
	movl	172(%esp), %eax
	movl	$_actual_str_buffer.61028, (%esp)
	movl	%eax, 4(%esp)
...
L1:
	...
	.cfi_endproc
LFE84:
.lcomm _actual_str_buffer.61028,8192,32
