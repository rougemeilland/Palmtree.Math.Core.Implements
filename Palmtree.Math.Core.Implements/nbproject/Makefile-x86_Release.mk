...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/Palmtree.Math.Core.Implements.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/Palmtree.Math.Core.Implements.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -mwindows -nostdlib -Wl,-e_DllMain@12 -Wl,-Map=Palmtree.Math.Core.Implements.map -shared

${OBJECTDIR}/INTERNALTEST_op_DivRem.o: INTERNALTEST_op_DivRem.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INTERNALTEST_op_DivRem.o INTERNALTEST_op_DivRem.c

${OBJECTDIR}/INTERNALTEST_op_Multiply.o: INTERNALTEST_op_Multiply.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INTERNALTEST_op_Multiply.o INTERNALTEST_op_Multiply.c

${OBJECTDIR}/TEST_autogenerated.o: TEST_autogenerated.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_autogenerated.o TEST_autogenerated.c

${OBJECTDIR}/TEST_op_Add.o: TEST_op_Add.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_Add.o TEST_op_Add.c

${OBJECTDIR}/TEST_op_BitwiseAnd.o: TEST_op_BitwiseAnd.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_BitwiseAnd.o TEST_op_BitwiseAnd.c
...
${OBJECTDIR}/TEST_op_Clone.o: TEST_op_Clone.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_Clone.o TEST_op_Clone.c
...
${OBJECTDIR}/TEST_op_ExclusiveOr.o: TEST_op_ExclusiveOr.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_ExclusiveOr.o TEST_op_ExclusiveOr.c

${OBJECTDIR}/TEST_op_From_To.o: TEST_op_From_To.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_From_To.o TEST_op_From_To.c

${OBJECTDIR}/TEST_op_GetPropertyValue.o: TEST_op_GetPropertyValue.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_GetPropertyValue.o TEST_op_GetPropertyValue.c

${OBJECTDIR}/TEST_op_GreatestCommonDivisor.o: TEST_op_GreatestCommonDivisor.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_GreatestCommonDivisor.o TEST_op_GreatestCommonDivisor.c

${OBJECTDIR}/TEST_op_ModPow.o: TEST_op_ModPow.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_ModPow.o TEST_op_ModPow.c
...
${OBJECTDIR}/TEST_op_Pow.o: TEST_op_Pow.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_Pow.o TEST_op_Pow.c

${OBJECTDIR}/TEST_op_Shift.o: TEST_op_Shift.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_Shift.o TEST_op_Shift.c
...
${OBJECTDIR}/TEST_op_ToStringD.o: TEST_op_ToStringD.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_ToStringD.o TEST_op_ToStringD.c

${OBJECTDIR}/TEST_op_ToStringN.o: TEST_op_ToStringN.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_ToStringN.o TEST_op_ToStringN.c

${OBJECTDIR}/TEST_op_ToStringX.o: TEST_op_ToStringX.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TEST_op_ToStringX.o TEST_op_ToStringX.c
...
${OBJECTDIR}/debug.o: debug.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/debug.o debug.c

${OBJECTDIR}/dllmain.o: dllmain.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dllmain.o dllmain.c

${OBJECTDIR}/memory.o: memory.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/memory.o memory.c

${OBJECTDIR}/pmc_add.o: pmc_add.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_add.o pmc_add.c

${OBJECTDIR}/pmc_bitwiseand.o: pmc_bitwiseand.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_bitwiseand.o pmc_bitwiseand.c
...
${OBJECTDIR}/pmc_bytes.o: pmc_bytes.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_bytes.o pmc_bytes.c

${OBJECTDIR}/pmc_clone.o: pmc_clone.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_clone.o pmc_clone.c
...
${OBJECTDIR}/pmc_exclusiveor.o: pmc_exclusiveor.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_exclusiveor.o pmc_exclusiveor.c

${OBJECTDIR}/pmc_from.o: pmc_from.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_from.o pmc_from.c

${OBJECTDIR}/pmc_getpropertyvalue.o: pmc_getpropertyvalue.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_getpropertyvalue.o pmc_getpropertyvalue.c

${OBJECTDIR}/pmc_greatestcommondivisor.o: pmc_greatestcommondivisor.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_greatestcommondivisor.o pmc_greatestcommondivisor.c

${OBJECTDIR}/pmc_initialize.o: pmc_initialize.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_initialize.o pmc_initialize.c

${OBJECTDIR}/pmc_modpow.o: pmc_modpow.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_modpow.o pmc_modpow.c

${OBJECTDIR}/pmc_multiply.o: pmc_multiply.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_multiply.o pmc_multiply.c

${OBJECTDIR}/pmc_parse.o: pmc_parse.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_parse.o pmc_parse.c

${OBJECTDIR}/pmc_pow.o: pmc_pow.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_pow.o pmc_pow.c

${OBJECTDIR}/pmc_shift.o: pmc_shift.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_shift.o pmc_shift.c

${OBJECTDIR}/pmc_statistics.o: pmc_statistics.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_statistics.o pmc_statistics.c

${OBJECTDIR}/pmc_subtruct.o: pmc_subtruct.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_subtruct.o pmc_subtruct.c

${OBJECTDIR}/pmc_to.o: pmc_to.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_to.o pmc_to.c

${OBJECTDIR}/pmc_tostring.o: pmc_tostring.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -DENABLED_PERFORMANCE_COUNTER -D_M_IX86  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pmc_tostring.o pmc_tostring.c
