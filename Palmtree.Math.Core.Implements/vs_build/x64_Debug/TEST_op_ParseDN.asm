...
PUBLIC	??_C@_1CK@DAPOFDPK@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA1?$AA?5?$AA?$CI?$AA?$CF@ ; `string'
...
PUBLIC	??_C@_1CK@JPFHBODA@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA2?$AA?5?$AA?$CI?$AA?$CF@ ; `string'
...
?actual_buf_size@?1??TEST_PMC_ParseDN1@@9@9 DQ 01H DUP (?) ; `TEST_PMC_ParseDN1'::`2'::actual_buf_size
?actual_buf@?1??TEST_PMC_ParseDN2@@9@9 DB 0100H DUP (?)	; `TEST_PMC_ParseDN2'::`2'::actual_buf
?actual_buf_size@?1??TEST_PMC_ParseDN2@@9@9 DQ 01H DUP (?) ; `TEST_PMC_ParseDN2'::`2'::actual_buf_size
_BSS	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$TEST_PMC_ParseDN1 DD imagerel $LN11
	DD	imagerel $LN11+655
	DD	imagerel $unwind$TEST_PMC_ParseDN1
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$TEST_PMC_ParseDN2 DD imagerel $LN11
	DD	imagerel $LN11+655
	DD	imagerel $unwind$TEST_PMC_ParseDN2
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_1CK@JPFHBODA@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA2?$AA?5?$AA?$CI?$AA?$CF@
CONST	SEGMENT
??_C@_1CK@JPFHBODA@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA2?$AA?5?$AA?$CI?$AA?$CF@ DB 'P'
	DB	00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'a', 00H, 'r', 00H
	DB	's', 00H, 'e', 00H, 'D', 00H, 'N', 00H, '2', 00H, ' ', 00H, '('
...
CONST	ENDS
;	COMDAT ??_C@_1CK@DAPOFDPK@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA1?$AA?5?$AA?$CI?$AA?$CF@
CONST	SEGMENT
??_C@_1CK@DAPOFDPK@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA1?$AA?5?$AA?$CI?$AA?$CF@ DB 'P'
	DB	00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'a', 00H, 'r', 00H
	DB	's', 00H, 'e', 00H, 'D', 00H, 'N', 00H, '1', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H					; `string'
CONST	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$TEST_PMC_ParseDN2 DD 025054a19H
	DD	011d2322H
	DD	070160033H
	DD	05015H
...
;	COMDAT CONST
CONST	SEGMENT
TEST_PMC_ParseDN2$rtcName$0 DB 078H
	DB	00H
	ORG $+2
TEST_PMC_ParseDN2$rtcName$1 DB 06fH
	DB	070H
	DB	074H
	DB	00H
	ORG $+8
TEST_PMC_ParseDN2$rtcVarDesc DD 088H
	DD	028H
	DQ	FLAT:TEST_PMC_ParseDN2$rtcName$1
	DD	028H
	DD	08H
	DQ	FLAT:TEST_PMC_ParseDN2$rtcName$0
	ORG $+96
TEST_PMC_ParseDN2$rtcFrameData DD 02H
	DD	00H
	DQ	FLAT:TEST_PMC_ParseDN2$rtcVarDesc
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$TEST_PMC_ParseDN1 DD 025054a19H
	DD	011d2322H
	DD	070160033H
	DD	05015H
	DD	imagerel __GSHandlerCheck
...
;	COMDAT CONST
CONST	SEGMENT
TEST_PMC_ParseDN1$rtcName$0 DB 078H
	DB	00H
	ORG $+2
TEST_PMC_ParseDN1$rtcName$1 DB 06fH
	DB	070H
	DB	074H
	DB	00H
	ORG $+8
TEST_PMC_ParseDN1$rtcVarDesc DD 088H
	DD	028H
	DQ	FLAT:TEST_PMC_ParseDN1$rtcName$1
	DD	028H
	DD	08H
	DQ	FLAT:TEST_PMC_ParseDN1$rtcName$0
	ORG $+96
TEST_PMC_ParseDN1$rtcFrameData DD 02H
	DD	00H
	DQ	FLAT:TEST_PMC_ParseDN1$rtcVarDesc
CONST	ENDS
...
; 77   :     TEST_Assert(env, FormatTestLabel(L"PMC_ParseDN2 (%d.%d)", no, 1), (x_result = ep->PMC_TryParse(str, styles, &opt, &x)) == desired_result_code, FormatTestMesssage(L"PMC_TryParseの復帰コードが期待通りではない(%d)", x_result));
...
$LN6@TEST_PMC_P:
	...
	lea	rcx, OFFSET FLAT:??_C@_1CK@JPFHBODA@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA2?$AA?5?$AA?$CI?$AA?$CF@
...
; 79   :     {
; 80   :         TEST_Assert(env, FormatTestLabel(L"PMC_ParseDN2 (%d.%d)", no, 2), (result = ep->PMC_ToByteArray(x, actual_buf, sizeof(actual_buf), &actual_buf_size)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToByteArrayの復帰コードが期待通りではない(%d)", result));
...
; 81   :         TEST_Assert(env, FormatTestLabel(L"PMC_ParseDN2 (%d.%d)", no, 3), _EQUALS_MEMORY(actual_buf, actual_buf_size, desired_buf, desired_buf_size) == 0, L"データの内容が一致しない");

	mov	r9, QWORD PTR desired_buf_size$[rbp]
	mov	r8, QWORD PTR desired_buf$[rbp]
	mov	rdx, QWORD PTR ?actual_buf_size@?1??TEST_PMC_ParseDN2@@9@9
	lea	rcx, OFFSET FLAT:?actual_buf@?1??TEST_PMC_ParseDN2@@9@9
	call	_EQUALS_MEMORY
	test	eax, eax
...
; 85   : }
	...
	pop	rbp
	ret	0
TEST_PMC_ParseDN2 ENDP
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File z:\sources\lunor\repos\rougemeilland\palmtree.math.core.implements\palmtree.math.core.implements\test_op_parsedn.c
;	COMDAT TEST_PMC_ParseDN1
_TEXT	SEGMENT
x$ = 8
result$ = 36
x_result$ = 68
...
styles$ = 432
group_separator$ = 440
decimal_separator$ = 448
positive_sign$ = 456
negative_sign$ = 464
desired_result_code$ = 472
desired_buf$ = 480
...
; 53   :     TEST_Assert(env, FormatTestLabel(L"PMC_ParseDN1 (%d.%d)", no, 1), (x_result = ep->PMC_TryParse(str, styles, &opt, &x)) == desired_result_code, FormatTestMesssage(L"PMC_TryParseの復帰コードが期待通りではない(%d)", x_result));
...
$LN6@TEST_PMC_P:
	...
	mov	r8d, 1
	mov	edx, DWORD PTR no$[rbp]
	lea	rcx, OFFSET FLAT:??_C@_1CK@DAPOFDPK@?$AAP?$AAM?$AAC?$AA_?$AAP?$AAa?$AAr?$AAs?$AAe?$AAD?$AAN?$AA1?$AA?5?$AA?$CI?$AA?$CF@
	call	FormatTestLabel
	mov	rcx, QWORD PTR tv64[rbp]
	mov	r9, rcx
	mov	r8d, DWORD PTR tv85[rbp]
...
; 55   :     {
; 56   :         TEST_Assert(env, FormatTestLabel(L"PMC_ParseDN1 (%d.%d)", no, 2), (result = ep->PMC_ToByteArray(x, actual_buf, sizeof(actual_buf), &actual_buf_size)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToByteArrayの復帰コードが期待通りではない(%d)", result));
...
; 57   :         TEST_Assert(env, FormatTestLabel(L"PMC_ParseDN1 (%d.%d)", no, 3), _EQUALS_MEMORY(actual_buf, actual_buf_size, desired_buf, desired_buf_size) == 0, L"データの内容が一致しない");

	mov	r9, QWORD PTR desired_buf_size$[rbp]
	mov	r8, QWORD PTR desired_buf$[rbp]
	mov	rdx, QWORD PTR ?actual_buf_size@?1??TEST_PMC_ParseDN1@@9@9
	lea	rcx, OFFSET FLAT:?actual_buf@?1??TEST_PMC_ParseDN1@@9@9
	call	_EQUALS_MEMORY
	test	eax, eax
	jne	SHORT $LN9@TEST_PMC_P
	mov	DWORD PTR tv152[rbp], 1
