...
PUBLIC	??_C@_1CE@NCPOKOMH@?$AAT?$AAo?$AAS?$AAt?$AAr?$AAi?$AAn?$AAg?$AAD?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF@ ; `string'
...
??_C@_1EA@HONIIPBB@?$AAP?$AAM?$AAC?$AA_?$AAT?$AAo?$AAS?$AAt?$AAr?$AAi?$AAn?$AAg?$AAn?$PP?$KJ?$AA0@ DB 'P'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1CE@NCPOKOMH@?$AAT?$AAo?$AAS?$AAt?$AAr?$AAi?$AAn?$AAg?$AAD?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF@
CONST	SEGMENT
??_C@_1CE@NCPOKOMH@?$AAT?$AAo?$AAS?$AAt?$AAr?$AAi?$AAn?$AAg?$AAD?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF@ DB 'T'
	DB	00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H, 'n', 00H
	DB	'g', 00H, 'D', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd', 00H, '.'
...
; 52   :     TEST_Assert(env, FormatTestLabel(L"ToStringD (%d.%d)", no, 1), (x_result = ep->PMC_FromByteArray(buf, buf_size, &x)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_FromByteArrayの復帰コードが期待通りではない(%d)", x_result));
...
$LN5@TEST_PMC_T:
	...
	lea	rcx, OFFSET FLAT:??_C@_1CE@NCPOKOMH@?$AAT?$AAo?$AAS?$AAt?$AAr?$AAi?$AAn?$AAg?$AAD?$AA?5?$AA?$CI?$AA?$CF?$AAd?$AA?4?$AA?$CF@
...
; 53   :     TEST_Assert(env, FormatTestLabel(L"ToStringD (%d.%d)", no, 2), (result = ep->PMC_ToString(x, actual_str_buffer, sizeof(actual_str_buffer), format_spec, min_width, &opt)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToStringの復帰コードが期待通りではない(%d)", result));
...
; 54   :     TEST_Assert(env, FormatTestLabel(L"ToStringD (%d.%d)", no, 3), lstrcmpW(actual_str_buffer, desired_str) == 0, L"データの内容が一致しない");
