...
;	COMDAT CONST
CONST	SEGMENT
TEST_PMC_ToStringN$rtcName$0 DB 078H
	DB	00H
	ORG $+2
TEST_PMC_ToStringN$rtcName$1 DB 06fH
	DB	070H
	DB	074H
	DB	00H
	ORG $+8
TEST_PMC_ToStringN$rtcVarDesc DD 098H
	...
	DD	038H
	DD	08H
	DQ	FLAT:TEST_PMC_ToStringN$rtcName$0
	ORG $+96
TEST_PMC_ToStringN$rtcFrameData DD 02H
	DD	00H
	DQ	FLAT:TEST_PMC_ToStringN$rtcVarDesc
CONST	ENDS
...
$LN10:
	...
	lea	rcx, OFFSET FLAT:__6032D7E2_test_op_tostringn@c
