...
$pdata$PMC_GreatestCommonDivisor_X_I_Imp DD imagerel PMC_GreatestCommonDivisor_X_I_Imp
	DD	imagerel PMC_GreatestCommonDivisor_X_I_Imp+1020
...
$pdata$PMC_GreatestCommonDivisor_X_L_Imp DD imagerel PMC_GreatestCommonDivisor_X_L_Imp
	DD	imagerel PMC_GreatestCommonDivisor_X_L_Imp+2800
...
; 972  :     _UINT32_T pos;
; 973  : #ifdef _MSC_VER
; 974  :     _BitScanForward(&pos, x);
; 975  : #elif defined(__GNUC__)
; 976  :     __asm__("bsfl %1, %0" : "=r"(pos) : "rm"(x));
; 977  : #else
; 978  : #error unknown compiler
; 979  : #endif
; 980  : #elif defined(_M_X64)
; 981  : #ifdef _MSC_VER
; 982  :     _UINT32_T pos;
; 983  :     _BitScanForward64(&pos, x);

	mov	rax, QWORD PTR x$[rbp]
	bsf	rax, rax
	mov	DWORD PTR pos$[rbp], eax

; 984  : #elif defined(__GNUC__)
; 985  :     _UINT64_T pos;
; 986  :     __asm__("bsfq %1, %0" : "=r"(pos) : "rm"(x));
; 987  : #else
; 988  : #error unknown compiler
; 989  : #endif
; 990  : #else
