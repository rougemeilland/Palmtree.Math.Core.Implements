...
_BSS	SEGMENT
entry_points DB	0208H DUP (?)
_BSS	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$PMC_Initialize DD imagerel $LN19
	DD	imagerel $LN19+1495
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$PMC_Initialize DD 025052a01H
	DD	010e2313H
	DD	070070021H
	DD	05006H
xdata	ENDS
;	COMDAT CONST
CONST	SEGMENT
PMC_Initialize$rtcName$0 DB 066H
	DB	065H
	DB	061H
	DB	074H
	DB	075H
	...
	DB	00H
	ORG $+8
PMC_Initialize$rtcVarDesc DD 024H
	DD	04H
	DQ	FLAT:PMC_Initialize$rtcName$0
	ORG $+48
PMC_Initialize$rtcFrameData DD 01H
	DD	00H
	DQ	FLAT:PMC_Initialize$rtcVarDesc
CONST	ENDS
...
$LN19:
	...
	lea	rcx, OFFSET FLAT:__33CE1650_pmc_initialize@c
...
; 154  : }
	...
	lea	rdx, OFFSET FLAT:PMC_Initialize$rtcFrameData
