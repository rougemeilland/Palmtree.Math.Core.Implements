...
;	COMDAT pdata
pdata	SEGMENT
$pdata$TEST_PMC_ParseDN1 DD imagerel $LN17
	DD	imagerel $LN17+518
	DD	imagerel $unwind$TEST_PMC_ParseDN1
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$TEST_PMC_ParseDN2 DD imagerel $LN17
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$TEST_PMC_ParseDN2 DD 092019H
	DD	0f00dc211H
	DD	0d009e00bH
	DD	07005c007H
	DD	050036004H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$TEST_PMC_ParseDN1 DD 092019H
	DD	0f00dc211H
	DD	0d009e00bH
	DD	07005c007H
	DD	050036004H
...
; 79   :         TEST_Assert(env, FormatTestLabel("PMC_ParseDN2 (%d.%d)", no, 2), (result = ep->PMC_To_X_B(x, actual_buf, sizeof(actual_buf), &actual_buf_size)) == PMC_STATUS_OK, FormatTestMesssage("PMC_To_X_Bの復帰コードが期待通りではない(%d)", result));
	...
	lea	rbp, OFFSET FLAT:?actual_buf@?1??TEST_PMC_ParseDN2@@9@9
	mov	rdx, rbp
...
styles$ = 208
group_separator$ = 216
decimal_separator$ = 224
positive_sign$ = 232
negative_sign$ = 240
desired_result_code$ = 248
desired_buf$ = 256
desired_buf_size$ = 264
...
$LN17:
	...
	xor	rax, rsp
	mov	QWORD PTR __$ArrayPad$[rsp], rax
	mov	rbx, QWORD PTR decimal_separator$[rsp]
	mov	r15, rdx
	mov	rdx, QWORD PTR group_separator$[rsp]
	mov	r12, rcx
	mov	rdi, QWORD PTR positive_sign$[rsp]
...
; 46   :     lstrcpyW(opt.GroupSeparator, group_separator);
	...
	lea	rcx, QWORD PTR opt$[rsp+4]
	mov	rsi, QWORD PTR negative_sign$[rsp]
	mov	rbp, r9
	mov	r13d, r8d
	call	QWORD PTR __imp_lstrcpyW
...
; 55   :         TEST_Assert(env, FormatTestLabel("PMC_ParseDN1 (%d.%d)", no, 2), (result = ep->PMC_To_X_B(x, actual_buf, sizeof(actual_buf), &actual_buf_size)) == PMC_STATUS_OK, FormatTestMesssage("PMC_To_X_Bの復帰コードが期待通りではない(%d)", result));
	...
	mov	rcx, QWORD PTR x$[rsp]
	lea	rbp, OFFSET FLAT:?actual_buf@?1??TEST_PMC_ParseDN1@@9@9
	mov	rdx, rbp
