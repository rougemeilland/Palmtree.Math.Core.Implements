...
; 443  : #ifdef _M_IX86
; 444  :     __stosd((unsigned long*)d, x, (unsigned long)count);
; 445  : #elif defined(_M_X64)
; 446  :     __stosq(d, x, count);
...
; 431  :     __stosd(( unsigned long*)d, x, count);
...
; 381  :     __stosd((unsigned long*)d, 0, count);
