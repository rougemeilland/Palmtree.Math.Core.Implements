; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27026.1 
	...
	TITLE	Z:\Sources\Lunor\Repos\rougemeilland\Palmtree.Math.Core.Implements\Palmtree.Math.Core.Implements\INTERNALTEST_op_Multiply.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG95692 DB	'actual_w_buf', 082H, 0ccH, 093H, 0e0H, 097H, 'e', 082H, 0aaH
	DB	094H, 'j', 091H, 0b9H, 082H, 0b5H, 082H, 0c4H, 082H, 0a2H, 082H
	DB	0e9H, 00H
	ORG $+3
$SG95693 DB	'Multiply_X_X_Imp (%d.%d)', 00H
	ORG $+3
$SG95694 DB	083H, 'f', 081H, '[', 083H, '^', 082H, 0ccH, 093H, 0e0H, 097H
	DB	'e', 082H, 0aaH, 088H, 0eaH, 092H, 'v', 082H, 0b5H, 082H, 0c8H
	DB	082H, 0a2H, 00H
	ORG $+3
$SG95695 DB	'Multiply_X_X_Imp (%d.%d)', 00H
_DATA	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File z:\sources\lunor\repos\rougemeilland\palmtree.math.core.implements\palmtree.math.core.implements\internaltest_op_multiply.c
_TEXT	SEGMENT
tv166 = -128						; size = 4
tv151 = -124						; size = 4
...
; 40   : {
	...
	rep stosd
	mov	ecx, OFFSET __6BD5A6F4_internaltest_op_multiply@c
	call	@__CheckForDebuggerJustMyCode@4
