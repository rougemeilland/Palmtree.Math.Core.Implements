...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG94686 DB	083H, 'e', 083H, 'X', 083H, 'g', 08aH, 'J', 08eH, 'n', 0aH
	DB	00H
$SG94709 DB	'x86', 00H
$SG94691 DB	083H, 'e', 083H, 'X', 083H, 'g', 08aH, 0aeH, 097H, 0b9H, 081H
	...
	DB	00H
	ORG $+1
$SG94708 DB	'PMC_Initialize failed', 00H
	ORG $+2
$SG94710 DB	'MSC', 00H
$SG94711 DB	'PLATFORM: %s', 0aH, 00H
	ORG $+2
$SG94712 DB	'COMPILER: %s', 0aH, 00H
	ORG $+2
$SG94713 DB	'CPU-INFO: POPCNT=%d, ADX=%d, BMI1=%d, BMI2=%d, ABM=%d', 0aH
	DB	00H
	ORG $+1
$SG94725 DB	'***NG***', 00H
	ORG $+3
$SG94726 DB	083H, 'e', 083H, 'X', 083H, 'g No.%d: %s => %s (%s)', 0aH
	DB	00H
_DATA	ENDS
...
; 78   :     char* platform = "x86";
	...
	mov	DWORD PTR _platform$[ebp], OFFSET $SG94709
...
; 85   :     char* compiler = "MSC";
	...
	mov	DWORD PTR _compiler$[ebp], OFFSET $SG94710
