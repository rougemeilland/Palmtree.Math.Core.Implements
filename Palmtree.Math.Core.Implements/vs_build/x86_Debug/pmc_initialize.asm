...
; 100  :     entry_points.PMC_To_X_I = PMC_To_X_I;
	...
	mov	DWORD PTR _entry_points+32, OFFSET _PMC_To_X_I@8

; 101  : 	entry_points.PMC_To_X_L = PMC_To_X_L;

	mov	DWORD PTR _entry_points+36, OFFSET _PMC_To_X_L@8
...
; 103  :     entry_points.PMC_ToString = PMC_ToString;
	...
	mov	DWORD PTR _entry_points+40, OFFSET _PMC_ToString@24

; 104  :     entry_points.PMC_TryParse = PMC_TryParse;

	mov	DWORD PTR _entry_points+44, OFFSET _PMC_TryParse@16

; 105  :     entry_points.PMC_Add_I_X = PMC_Add_I_X;

	mov	DWORD PTR _entry_points+48, OFFSET _PMC_Add_I_X@12

; 106  : 	entry_points.PMC_Add_L_X = PMC_Add_L_X;

	mov	DWORD PTR _entry_points+52, OFFSET _PMC_Add_L_X@16

; 107  :     entry_points.PMC_Add_X_I = PMC_Add_X_I;

	mov	DWORD PTR _entry_points+56, OFFSET _PMC_Add_X_I@12

; 108  :     entry_points.PMC_Add_X_L = PMC_Add_X_L;

	mov	DWORD PTR _entry_points+60, OFFSET _PMC_Add_X_L@16

; 109  :     entry_points.PMC_Add_X_X = PMC_Add_X_X;

	mov	DWORD PTR _entry_points+64, OFFSET _PMC_Add_X_X@12

; 110  :     entry_points.PMC_Subtruct_I_X = PMC_Subtruct_I_X;

	mov	DWORD PTR _entry_points+68, OFFSET _PMC_Subtruct_I_X@12

; 111  :     entry_points.PMC_Subtruct_L_X = PMC_Subtruct_L_X;

	mov	DWORD PTR _entry_points+72, OFFSET _PMC_Subtruct_L_X@16

; 112  :     entry_points.PMC_Subtruct_X_I = PMC_Subtruct_X_I;

	mov	DWORD PTR _entry_points+76, OFFSET _PMC_Subtruct_X_I@12

; 113  :     entry_points.PMC_Subtruct_X_L = PMC_Subtruct_X_L;

	mov	DWORD PTR _entry_points+80, OFFSET _PMC_Subtruct_X_L@16

; 114  :     entry_points.PMC_Subtruct_X_X = PMC_Subtruct_X_X;

	mov	DWORD PTR _entry_points+84, OFFSET _PMC_Subtruct_X_X@12

; 115  :     entry_points.PMC_Multiply_I_X = PMC_Multiply_I_X;

	mov	DWORD PTR _entry_points+88, OFFSET _PMC_Multiply_I_X@12

; 116  :     entry_points.PMC_Multiply_L_X = PMC_Multiply_L_X;

	mov	DWORD PTR _entry_points+92, OFFSET _PMC_Multiply_L_X@16

; 117  :     entry_points.PMC_Multiply_X_I = PMC_Multiply_X_I;

	mov	DWORD PTR _entry_points+96, OFFSET _PMC_Multiply_X_I@12

; 118  :     entry_points.PMC_Multiply_X_L = PMC_Multiply_X_L;

	mov	DWORD PTR _entry_points+100, OFFSET _PMC_Multiply_X_L@16

; 119  :     entry_points.PMC_Multiply_X_X = PMC_Multiply_X_X;

	mov	DWORD PTR _entry_points+104, OFFSET _PMC_Multiply_X_X@12

; 120  :     entry_points.PMC_DivRem_I_X = PMC_DivRem_I_X;

	mov	DWORD PTR _entry_points+108, OFFSET _PMC_DivRem_I_X@16

; 121  :     entry_points.PMC_DivRem_L_X = PMC_DivRem_L_X;

	mov	DWORD PTR _entry_points+112, OFFSET _PMC_DivRem_L_X@20

; 122  :     entry_points.PMC_DivRem_X_I = PMC_DivRem_X_I;

	mov	DWORD PTR _entry_points+116, OFFSET _PMC_DivRem_X_I@16

; 123  :     entry_points.PMC_DivRem_X_L = PMC_DivRem_X_L;

	mov	DWORD PTR _entry_points+120, OFFSET _PMC_DivRem_X_L@20

; 124  :     entry_points.PMC_DivRem_X_X = PMC_DivRem_X_X;

	mov	DWORD PTR _entry_points+124, OFFSET _PMC_DivRem_X_X@16
...
; 126  :     entry_points.PMC_RightShift_X_L = PMC_RightShift_X_L;
	...
	mov	DWORD PTR _entry_points+140, OFFSET _PMC_RightShift_X_L@16

; 127  :     entry_points.PMC_LeftShift_X_I = PMC_LeftShift_X_I;

	mov	DWORD PTR _entry_points+128, OFFSET _PMC_LeftShift_X_I@12

; 128  :     entry_points.PMC_LeftShift_X_L = PMC_LeftShift_X_L;

	mov	DWORD PTR _entry_points+132, OFFSET _PMC_LeftShift_X_L@16
...
; 164  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN24@PMC_Initia
