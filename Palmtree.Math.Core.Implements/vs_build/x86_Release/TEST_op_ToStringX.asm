...
PUBLIC	??_C@_0BC@LJLKDEI@ToStringX?5?$CI?$CFd?4?$CFd?$CJ@ ; `string'
...
??_C@_0CP@LPHACLNN@PMC_ToString?$IC?L?$JF?$JM?$ILA?$IDR?$IB?$FL?$IDh?$IC?$KK?$IK?z?$JB?R?$JC@ DB 'P'
	...
	DB	'%d)', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@LJLKDEI@ToStringX?5?$CI?$CFd?4?$CFd?$CJ@
CONST	SEGMENT
??_C@_0BC@LJLKDEI@ToStringX?5?$CI?$CFd?4?$CFd?$CJ@ DB 'ToStringX (%d.%d)', 00H ; `string'
CONST	ENDS
...
_TEST_PMC_ToStringX PROC				; COMDAT
...
; 51   :     TEST_Assert(env, FormatTestLabel("ToStringX (%d.%d)", no, 1), (x_result = ep->PMC_From_B(buf, buf_size, &x)) == PMC_STATUS_OK, FormatTestMesssage("PMC_From_Bの復帰コードが期待通りではない(%d)", x_result));
	...
	push	OFFSET ??_C@_0BC@LJLKDEI@ToStringX?5?$CI?$CFd?4?$CFd?$CJ@
